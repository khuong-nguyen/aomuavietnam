<?php
require_once AppPHPThumb.'phpthumb/ThumbLib.inc.php';

/*-----------------------------------------------------+
 * php thumb
 +----------------------------------------------------*/
 function vnitResizeImageScrop($linkImageRoot, $linkImageThumb ,$width=null, $height=null){
 	$thumb = PhpThumbFactory::create($linkImageRoot);
	$thumb->cropFromCenter($width,$height);
 	//luu ************************************
	$thumb->save($linkImageThumb);	
}

function vnitResizeImage($linkImageRoot, $linkImageThumb ,$width=null, $height=null){
	$thumb = PhpThumbFactory::create($linkImageRoot);
	$thumb->adaptiveResize($width, $height);
	//luu ************************************
	if($thumb->save($linkImageThumb)){
		return true;
	}else{
		return false;
	}
