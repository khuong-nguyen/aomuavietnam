    ...
    <tr>
        ...
        <td>
			<div id="swfupload-control">
				<p>Kiểu hình uploads:(.jpg, .png,.gif,.swf), dung lượng tối đa: 1MB  - <strong>KT: W:705px - H: 252px</strong></p>
			...
			<div class="upload-img" id="imgBody">
				...
				<?php }?>
				<input type="hidden" value="<?php echo $fileBanner;?>" name="view-banner"> 
			</div>
		</td>
    </tr>
    <tr>
        <td class="label">Link:</td>
        <td><input type="text" name="link-banner" value="<?php echo $linkBanner;?>" class="w350"></td>
    </tr>
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			$('#imgBody').html('<img src="'+imgPath+'" width="90" height="136"/><br><input type="hidden" name="view-banner" value="'+serverData+'">');
