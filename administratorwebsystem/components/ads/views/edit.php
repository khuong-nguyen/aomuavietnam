...
<table class="form">
    <tr>
        ...
        <td><input type="text" name="ads[name]" value="<?php echo $rs->name;?>" class="w350"></td>
    </tr>
    <tr>
        <td class="label">Hình ảnh</td>
        <td>
			<div id="swfupload-control">
				<p>Kiểu hình uploads:(jpg, png, gif), dung lượng tối đa: 1MB  - KT: W:770px - H: 335px</p>
			...
			<div class="upload-img" id="imgBody">
				...
				<input type="hidden" value="<?php echo $rs->image;?>" name="img"> 
			</div>
		</td>
    </tr>
     <tr>
        <td class="label">Link:</td>
        <td><input type="text" name="ads[url]" value="<?php echo $rs->url;?>" class="w350"></td>
    </tr>
     <tr>
