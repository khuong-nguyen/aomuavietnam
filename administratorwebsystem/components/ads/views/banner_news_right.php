    ...
    <tr>
        ...
        <td>
			<div id="swfupload-control">
				<p>Kiểu hình uploads:(.jpg, .png,.gif,.swf), dung lượng tối đa: 1MB  - <strong>KT: W:280px - H: 252px</strong></p>
			...
			<div class="upload-img" id="imgBody">
				...
				<?php }?>
				<input type="hidden" value="<?php echo $fileBanner;?>" name="view-news"> 
			</div>
		</td>
    </tr>
    <tr>
        <td class="label">Link:</td>
        <td><input type="text" name="link-news" value="<?php echo $linkNews;?>" class="w350"></td>
    </tr>
</table>
<?php echo form_close();?>
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			$('#imgBody').html('<embed src="'+imgPath+'" width="90" height="136"><br><input type="hidden" name="view-news" value="'+serverData+'">');
