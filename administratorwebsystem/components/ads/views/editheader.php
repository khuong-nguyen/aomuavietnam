    ...
    <tr>
        ...
        <td>
			<div id="swfupload-control">
				<p>Kiểu hình uploads:(.jpg, .png,.gif,.swf), dung lượng tối đa: 1MB  - <strong>KT: W:210px - H: auto</strong></p>
			...
			<div class="upload-img" id="imgBody">
				...
				<?php }?>
				<input type="hidden" value="<?=$fileFlash;?>" name="view-header"> 
			</div>
		</td>
    </tr>
...
$(function(){
	$('#swfupload-control').swfupload({
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			$('#imgBody').html('<img src="'+imgPath+'" width="150" height="44"><br><input type="hidden" name="view-header" value="'+serverData+'">');
