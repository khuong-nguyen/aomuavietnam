...
<table class="form">
    <tr>
        ...
        <td>
            <select name="pay_vi[parentid]">
                ...
                <?foreach($list as $val):?>
                <option value="<?=$val->payment_id?>"><?=$val->payment_name?></option>
                <?endforeach;?>
            </select>
        </td>
        <td></td>
    ...
    <tr>
        ...
        <td>
             <input type="text" name="pay_vi[payment_name]" value="<?=set_value('pay_vi[payment_name]')?>" class="w350">
        </td>
        <td rowspan="4">
    ...
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= base_url().'templates/images/noImage.gif';
				?>
    ...
    <tr>
        ...
        <td><input type="text" name="pay_vi[payment_code]" value="<?=set_value('pay_vi[payment_code]')?>" class="w200"></td>
    </tr>
    <tr>
        <td class="label">User</td>
        <td><input type="text" name="pay_vi[merchant_id]" value="<?=set_value('pay_vi[merchant_id]')?>" class="w200"></td>
    </tr>
    <tr>
        <td class="label">Mật khẩu</td>
        <td colspan="2"><input type="text" name="pay_vi[access_code]" value="<?=set_value('pay_vi[access_code]')?>" class="w200"></td>
    </tr>
    <tr>
        <td class="label">Secure Hash</td>
        <td colspan="2"><input type="text" name="pay_vi[secure_hash]" value="<?=set_value('pay_vi[secure_hash]')?>" class="w200"></td>
    </tr>
    <tr>
        <td class="label">Url Pay</td>
        <td colspan="2"><input type="text" name="pay_vi[url_pay]" value="<?=set_value('pay_vi[url_pay]')?>" class="w200"></td>
    </tr>
    <tr>
        <td class="label">Sắp xếp</td>
        <td colspan="2"><input type="text" name="ordering" value="<?=$this->vdb->find_by_order('shop_payment','ordering')?>"></td>
    </tr>
    <tr>
        <td class="label">Giới thiệu</td>
        <td colspan="2">
            <?=vnit_editor_basic(set_value('pay_vi[payment_intro]'),'pay_vi[payment_intro]','intro_vi')?>
        </td>
    </tr>
...
<table class="form">
    <tr>
        ...
        <td>
            <?=vnit_editor_basic(set_value('pay_vi[payment_des]'),'pay_vi[payment_des]','full')?>
        </td>
    </tr>
