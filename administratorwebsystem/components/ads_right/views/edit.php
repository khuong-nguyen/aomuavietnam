...
<table class="form">
    <tr>
        ...
        <td><input type="text" name="ads[name]" value="<?php echo $rs->name;?>" class="w300"></td>
    </tr>
     <tr>
        <td class="label">Giá thị trường:</td>
        <td><input type="text" name="price_old"  id="price_old" value="<?php echo number_format($rs->price_old,'.','.','.');?>" class="w300"></td>
    </tr>
     <tr>
        <td class="label">Giá bán:</td>
        <td><input type="text" name="price" id="price" value="<?php echo number_format($rs->price,'.','.','.');?>" class="w300"></td>
    </tr>
    <tr>
        <td class="label">Ghi chú:</td>
        <td><input type="text" name="ads[note]" value="<?php echo $rs->note;?>" class="w450"></td>
    </tr>
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->image))? base_url_site().'data/ads_right/full_images/'.$rs->image:base_url_site().'site/templates/default/images/no_image.gif';
				?>
     ...
     <tr>
        ...
        <td><input type="text" name="ads[url]" value="<?=$rs->url;?>" class="w300"> (vd: http://congdulich.com)</td>
    </tr>
     <tr>
	 ...
	 <tr>
        ...
        <td><input type="radio" value="1" name="ads[published]" <?php echo ($rs->published == 1)?'checked="checked"':'';?>>Hiện <input type="radio" name="ads[published]" value="0" <?php echo ($rs->published == 0)?'checked="checked"':'';?>>Không</td>
    </tr>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('ads_right/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>data/ads_right/full_images/'+serverData;	
