...
<table class="form">
    <tr>
     ...
     <tr>
        ...
        <td><input type="text" name="price_old" id="price_old" value="" class="w300"></td>
    </tr>
     <tr>
        <td class="label">Giá bán:</td>
        <td><input type="text" name="price" id="price" value="" class="w300"></td>
    </tr>
     <tr>
        <td class="label">Ghi chú:</td>
        <td><input type="text" name="ads[note]" value="" class="w450"></td>
    </tr>
    <tr>
