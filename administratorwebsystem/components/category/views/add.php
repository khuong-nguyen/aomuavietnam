...
<table class="form">
   ...
   <tr>
     ...
     <tr>
        ...
        <td><input type="radio" name="cat[is_home]" value="0" <?php echo (set_value('cat[is_home]') == 0)?'checked="checked"':'checked="checked"';?>> Không <input type="radio" name="cat[is_home]" value="1" <?php echo (set_value('cat[is_home]') == 1)?'checked="checked"':'';?>>Có</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="cat[ordering]" value="1"></td>
    </tr>
     <tr>
        <td class="label">Hiển thị: (*)</td>
        <td><input type="radio" name="cat[published]" value="0" > Không <input type="radio" name="cat[published]" value="1" checked="checked">Có</td>
    </tr>
</table>
<?php echo form_close();?>
