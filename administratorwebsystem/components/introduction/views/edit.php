            ...
            <td valign="top">
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" name="con[name]" value="<?php echo $rs->name;?>" class="w400"></td>
                    ...
                    <tr>
				        ...
				        <td>
							...
							<div class="upload-img" id="imgBody">
								<?php
								$img	= (!empty($rs->img))? base_url_site().'data/introduction/full_images/'.$rs->img:base_url_site().'site/templates/default/images/no_image.gif';
								?>
								<img src="<?php echo $img;?>" width="85"><br>
								<input type="hidden" value="<?php echo $rs->img;?>" name="img"> 
							</div>
						</td>
				    </tr>
    				  <tr>
                        ...
                        <td>
                            <input type="text" name="con[ordering]" value="<?php echo $rs->ordering;?>">  
                    ...
                    <tr>
                        <td colspan="4"><?php echo vnit_editor($rs->content,'content','full',false)?></td>                    
                    </tr>
                    <tr>
                        <td class="label">Hiển thị</td>
                        <td>
                            <input type="radio" name="con[status]" value="0" <?php echo ($rs->status == 0)?'checked="checked"':'';?>> Không 
                            <input type="radio" name="con[status]" value="1" <?php echo ($rs->status == 1)?'checked="checked"':'';?>>Có                        
                        </td>
                    </tr> 
                </table>
            </td>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('introduction/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>data/introduction/full_images/'+serverData;	
