...
<table class="form">
	<tr>
        ...
        <td>
            <select name="cat[cat_id]" class="w300">
                <option value="0">Chủ đề chính</option>
                <?php foreach($list as $val):?>
                	<option value="<?php echo $val->cat_id?>" <?php echo ($val->cat_id == $rs->cat_id)?'selected="selected"':'';?>><?php echo $val->cat_title?></option>
			        ...
			        ?>
			        	<option value="<?php echo $valSubCbo->cat_id?>" <?php echo ($valSubCbo->cat_id == $rs->cat_id)?'selected="selected"':'';?>><?php echo '&nbsp;&nbsp;&nbsp;|_ '.$valSubCbo->cat_title?></option>
			        <?php 
			        endforeach;
    ...
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->image))? base_url_site().'data/ads_category/full_images/'.$rs->image:base_url_site().'site/templates/default/images/no_image.gif';
				?>
     ...
     <tr>
        ...
        <td><input type="text" name="ads[url]" value="<?php echo $rs->url;?>" class="w300"> (vd: http://congdulich.com)</td>
    </tr>
     <tr>
        <td class="label">Sắp xếp:</td>
        <td><input type="text" name="ads[ordering]" value="<?php echo $rs->ordering;?>"></td>
    </tr>
	 <tr>
