...
<table class="admindata">
    <thead>
        ...
        <tr>
            ...
            <th class="id"><?=vnit_order('thanhpho/listthanhpho/0/city_id/desc','ID')?></th>
    ...
    <tr class="row1">
        ...
        <td align="center">
            ...
            <span id="publish<?php echo $pr->city_id?>"><?php echo icon_active("'thanhpho'","'city_id'",$pr->city_id,$pr->published)?></span>        
