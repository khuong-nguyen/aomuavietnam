...
class vfile extends CI_Controller{
    ...
    function vupload(){
        ...
        $dir = str_replace('admin/','',$dir_upload).'/';
        ...
        if (move_uploaded_file($_FILES['Filedata']['tmp_name'], $filename)) {   
            $folder_new = str_replace(array("admin/","vfile/","vfile_dir/"),array('','',''),$this->input->post('folder'));
            
            $dir_new = str_replace('data','data/thumbs_',$dir);
            // Return seg[4];
            $seg_4 = str_replace('admin/','',$folder_new).'/'.$file_name.$extension;
            ...
            if($extension =='jpg' || $extension =='jpeg' || $extension =='png' || $extension =='gif'){
                ...
                echo str_replace(array('data','admin/'),array('data/thumbs_',''),$folder_new).'/'.$file_name.$extension.'|'.$file_name.$extension.'|'.$extension.'|'.$seg_4;
            }else{
