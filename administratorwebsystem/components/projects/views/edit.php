            ...
            <td valign="top">
                <table class="form">
                   ...
                   <tr>
                        ...
                        <td>
                        	<textarea rows="7" cols="70" name="con[summary]"><?php echo $rs->summary;?></textarea>
                        </td>
                    ...
                    <tr>
				        ...
				        <td>
							...
							<div class="upload-img" id="imgBody">
								<?php
								$img	= (!empty($rs->img))? base_url_site().'data/projects/full_images/'.$rs->img:base_url_site().'site/templates/default/images/no_image.gif';
								?>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('projects/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>data/projects/full_images/'+serverData;	
