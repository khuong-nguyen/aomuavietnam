            ...
            <td valign="top">
                <table class="form">
                    <tr>
                        ...
                        <td><input type="text" name="con[name]" value="" class="w400"></td>
                    ...
                    <tr>
                        ...
                        <td>
                        	<textarea rows="7" cols="70" name="con[summary]"></textarea>
                        </td>
                    ...
                    <tr>
                        <td colspan="4"><?php echo vnit_editor('','content','full',false)?></td>                    
                    </tr>
                    
                      <tr>
                        <td class="label">Hiển thị</td>
                        <td>
                            <input type="radio" name="con[published]" value="0"> Không 
                            <input type="radio" name="con[published]" value="1" checked="checked">Có                        
                        </td>
                    </tr>                    
