...
<table class="form">
    <tr>
        ...
        <td><input type="text" name="ads[name]" value="<?=$rs->name;?>" class="w300"></td>
    </tr>
    <tr>
        ...
        <td>
			...
			<div class="upload-img" id="imgBody">
				<?php
				$img	= (!empty($rs->image))? base_url_site().'data/ads_doitac/full_images/'.$rs->image:base_url_site().'site/templates/default/images/no_image.gif';
				?>
...
$(function(){
	$('#swfupload-control').swfupload({
		upload_url: "<?php echo site_url('ads_doitac/uploader');?>",
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var imgPath = '<?=base_url_site();?>data/ads_doitac/full_images/'+serverData;	
