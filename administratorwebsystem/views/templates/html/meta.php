...
<link type="text/css" rel="stylesheet" href="<?php echo base_url();?>templates/css/nav_left.css?v=2.0" media="screen" />
...
<script type="text/javascript" src="<?php echo base_url();?>templates/ckeditor/ckeditor.js"></script>
<?php 
...
<script type="text/javascript">
    ...
    var base_url_site = '<?php echo base_url_site();?>';
    var base_url_img = '<?php echo base_url_img();?>';
</script>
