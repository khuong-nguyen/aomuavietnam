<?php
      ...
      function send_mail_templates($to,$subject,$message){
          $CI = get_instance();          
          $mess =$message;
          $contact_name = "=?UTF-8?B?".base64_encode('WWW.aomuavietnam.com').'?=';
          $headers = "From: ".$contact_name." <info@aomuavietnam.com>\n";
          $headers .= "Reply-To: ".$contact_name." <info@aomuavietnam.com>\n";
          $headers .= "MIME-Version: 1.0\n";
          $headers .= "Content-Type: text/html; charset=UTF-8\n";
