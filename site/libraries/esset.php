...
class Esset {
    ...
    */
    public function __construct()
    {
        ...
        if( $this->CI->config->load('esset', TRUE, TRUE) ){
        
            log_message('debug', 'Carabiner config loaded from config file.');
            
            $esset_config = $this->CI->config->item('esset');
            $this->config($esset_config);
        }
    ...
    */    
    ...
    {    
        ...
        $this->cache_path =dirname(FCPATH).'/thanhvien/'.$this->cache_dir;
