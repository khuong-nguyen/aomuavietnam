<?php
  class CI_pagi{
          ...
          //$id_blog = $this->input->post('id_blog');
            ...
            */
            ...
            {    
                ...
                //previous button
                if ($page > 1) 
                    $pagination.= "<a href=\"javascript:;\" onclick=\"GoToPage($page-1,$pageid)\">&lt;</a>";
                else
      ...
      function page($num,$offset,$limit){
          //$id_blog = $this->input->post('id_blog');
            $page = $offset;
            $adjacents = 2;
            ...
            */
            ...
            {    
                ...
                //previous button
                if ($page > 1){ 
                    $pagination.= "<a href=\"javascript:;\" onclick=\"go($page-1)\">&lt;</a>";
                }else{
                    $pagination.= "<a href=\"javascript:;\">&lt;</a>";    
                }
                ...
                {    
                    for ($counter = 1; $counter <= $lastpage; $counter++)
                    {
                        if ($counter == $page)
                            ...
                            $pagination.= "<a href=\"javascript:; \" onclick=\"go($counter)\">$counter</a>";                    
                    }
                }
                elseif($lastpage > 4 + ($adjacents * 2))    //enough pages to hide some
                {
                    ...
                    if($page < 1 + ($adjacents * 2))        
                    {
                        ...
                        $pagination.= "...";
                        $pagination.= "<a href=\"javascript:; \" onclick=\"go($lpm1)\">$lpm1</a>";
                        $pagination.= "<a href=\"javascript:; \" onclick=\"go($lastpage)\">$lastpage</a>";        
                    }
                    //in middle; hide some front and some back
                    elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
                    {
                        $pagination.= "<a href=\"javascript:; \" onclick=\"go(1)\">1</a>";
                        $pagination.= "<a href=\"javascript:;\" onclick=\"go(2)\">2</a>";
                        $pagination.= "...";
                        for ($counter = $page - $adjacents; $counter <= $page + $adjacents; $counter++)
                        {
                            if ($counter == $page)
