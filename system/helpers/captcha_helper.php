...
if ( ! function_exists('create_captcha'))
{
	...
	{
		$defaults = array('word' => '', 'img_path' => '', 'img_url' => '', 'img_width' => '70', 'img_height' => '30', 'font_path' => 'mobifone.ttf', 'expiration' => 7200);
	   ...
	   if ($word == '')
	   {
		...
		for ($i = 0; $i < strlen($word); $i++)
		{
			...
			{
				$y = rand($img_height-5, $img_height-5);
		...
		imagerectangle($im, 0, 0, 70, $img_height-1, $border_color);
